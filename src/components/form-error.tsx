...
interface FormErrorProps extends HTMLAttributes<HTMLElement> {
  data: Partial<typeof data.formErrorPage>;
}

const FormErrorSection = ({ data, className }: FormErrorProps): JSX.Element => {
  return (
    <section
        ...
        <div className="grid grid-cols-16">
          ...
          <h1
            className={classNames(
              ...
              "text-25 md:text-30 mb-40 md:mb-80 lg:mb-0 leading-snug font-normal text-red-400 lg:max-w-[260px]"
            )}
          >
            Ein Fehler ist aufgetreten
            <AlertIcon className="h-25 w-25 inline-block ml-6 mb-5 md:h-[32px] md:w-[32px] md:ml-10" />
          </h1>
            ...
            >
              ...
              {data.link && (
                <Link href={data.link.href}>
                  <a className="text-teal-300 hover:text-brown-700">
                    {data.link.label}
